...
Donate link: https://linktr.ee/allen_mckenzie 
...
1. Publish Business Matchup Poll and View
2. Create App Page
3. Enter New App Details
4. Create App Error
5. Create App Success
6. Add New Business Matchup Poll
7. Enter Business Matchup Poll Details
8. Business Matchup Poll Example
...
-  1.0.1: Patch for gutenberg and page builder sites